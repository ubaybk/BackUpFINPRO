            ...
            <div className=" flex flex-col  gap-5 ">
              <div>
                <Link
                  ...
                  to={`/detailuser/${postDetail.userId}`}
                >
                  <img
                    src={postDetail?.user?.profilePictureUrl || defaultPhoto}
                    onError={(e) => {
                    ...
                    alt=""
                  />
                  <p>{postDetail?.user?.username || <p>unknown</p>}</p>
                </Link>
              </div>
              <img src={postDetail.imageUrl || defaultPhoto} onError={(e) => {
                    e.target.src = defaultPhoto;
                  }}  className="md:w-[600px] md:h-[300px] md:object-cover" alt="" />
              <p>{postDetail.caption}</p>{" "}
              {/* Menampilkan data lain sesuai kebutuhan */}
            </div>
          ) : (
